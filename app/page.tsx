...
const problems = [
  { id: 1, text: `問題1: 成績が60以上なら「合格」それ未満では「不合格」と表示するプログラムを書いてください
    ` },
  { id: 2, text: `問題2: ユーザーから出席状況を入力させ、その入力に応じてメッセージを表示するプログラムを書いてください
      （「出席」「欠席」「遅刻」）
      「欠席」の場合は「授業を受けていません」
      「出席」または「遅刻」の場合は「授業を受けています」と表示してください`
   },
  { id: 3, text: `問題3: 注文する飲み物を入力し、その選択に応じて値段を表示する
      プログラムを書いてください。なお入力される交通手段は「コーヒー 400円」「紅茶 350円」「ジュース 300円」です` },
